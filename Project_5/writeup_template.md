...
- [The pipeline visualization](#the-pipeline-visualization)
...
The pipeline is able to correctly label cars areas on a video frames.
...
- The pipeline is not a real-time. One can further optimize number of features and feature extraction parameters as well as number of analyzed windows to increase the rate.
